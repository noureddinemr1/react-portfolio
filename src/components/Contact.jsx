...
const Contact = () => {
  ...
  const validate = () => {
    ...
    let object = form.current.object.value.trim();
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_0k3k83s', 'template_urd1l6j', form.current, 
      {publicKey: 'nxsj-fhyPnBYWEN5R'})
      .then(
        () => {
        ...
        <div className="grid  sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-transparent font-[sans-serif] md:mt-7 md:ml-14">
            ...
            <form className="ml-auto space-y-4" ref={form}  onSubmit={sendEmail}>
                <input type='text' placeholder='Name' name="user_name"
                    className={`w-full rounded-md py-3 px-4 bg-gray-100 text-gray-800 text-sm shadow-none outline-cyan-500 focus:bg-transparent tansition duration-300 ${
                      errors.name? "border-red-400 focus:outline-red-400"
                        : "border-none"
                    }`}/>
                    {errors.name && (
                ...
                <input type='text' placeholder='Email' name="user_email"
                    className={`w-full rounded-md py-3 px-4 bg-gray-100 text-gray-800 text-sm outline-cyan-500 focus:bg-transparent tansition duration-300 ${
                      errors.email? "border-red-400 focus:outline-red-400"
                        : "border-none"
                    }`}/>
                    {errors.email && (
